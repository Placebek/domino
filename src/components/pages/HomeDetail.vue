    ...
    <div v-if="house">
      ...
      >
        ...
        <div
          ...
          :style="{ backgroundImage: `url(https://py-storm.space/${house.photos[currentPhotoIndex].photo_link})` }"
        ></div>
        ...
        >
          ...
          >
            <img
              :src="'https://py-storm.space/' + house.photos[currentPhotoIndex].photo_link"
              alt="House photo"
